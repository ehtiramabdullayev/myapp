...
class Message(models.Model):
    ...
    spec_from = models.IntegerField('Specialist', db_column='Spec_from', blank=True, null=True) # Field name made lowercase.
    spec_to = models.IntegerField('Specialist', db_column='Spec_to', blank=True, null=True) # Field name made lowercase.
    def __unicode__(self):
            return self.title
...
class Specialist(models.Model):
    ...
    # slogin = models.ForeignKey(User, unique=True, related_name='username')
    # sid = models.ForeignKey(User, unique=True, related_name='id')
    # spassword = models.ForeignKey(User, unique=True, related_name='password')
